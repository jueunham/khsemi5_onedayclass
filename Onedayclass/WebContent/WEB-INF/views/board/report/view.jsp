...
$(document).ready(function() {
	...
	$("#btnList").click(function() {
		$(location).attr("href", "/board/report/list");
	});
	
	//수정버튼 동작
	$("#btnUpdate").click(function() {
		$(location).attr("href", "/board/report/update?boardno=${viewBoard.boardno }");
	});

	//삭제버튼 동작
	$("#btnDelete").click(function() {
		$(location).attr("href", "/board/report/delete?boardno=${viewBoard.boardno }");
	});
