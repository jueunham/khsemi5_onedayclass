...
<h4>개인정보 보호 정책</h4>	
Oneday Class(이하 “회사”)는 회사가 운영하는 인터넷 사이트를 이용하는 이용자님들의 개인정보를 매우 중요하게 생각하며 아래와 같은 개인 정보취급방침을 가지고 있습니다. 이 개인정보취급방침은 개인정보와 관련한 법령 또는 지침의 변경이 있는 경우 갱신되고, 정책의 변화에 따라 달라질 수 있으니 이용자께서는 Oneday Class을 방문 시 수시로 확인하여 주시기 바랍니다. 회사의 개인정보취급방침은 다음과 같은 내용을 담고 있습니다. 
...
나. 개인정보의 조회/수정을 위해서는 사이트의 [마이페이지]내의 [회원정보수정] 항목에서 확인 가능하며, 가입 해지(동의철회)는 Oneday Class센터로 연락하면 회사에서 요청사항에 대해 처리합니다. 이 외에도 회사의 개인정보 보호책임자에게 서면, 전화 또는 이메일로 연락하여 열람/수정/탈퇴를 요청하실 수 있습니다. 
...
이용약관 내용 추가, 삭제 및 수정이 있을 시에는 개정 최소 7일 전부터 Oneday Class 사이트의 공지사항을 통해 고지합니다. 
...
<button id="prev"><a href="#" onClick="history.back()">이전으로</a></button>
