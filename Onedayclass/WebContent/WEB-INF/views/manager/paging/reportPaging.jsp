...
<div class="text-center">
	<ul class="pagination pagination-sm">
		...
		<li>
			<a href="/admin/board/report/list"><span>&larr;처음</span></a>
		</li>
		</c:if>
		...
		<li>
			<a href="/admin/board/report/list?curPage=${reportPaging.curPage-1 }"><span>&laquo;</span></a>
	    </li>
	    </c:if>
		...
		<c:forEach
	     ...
	     var="i">
			...
			<li class="active">
				<a href="/admin/board/report/list?curPage=${i }">${i }</a>
			</li>
			</c:if>
