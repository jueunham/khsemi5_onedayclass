...
function checkedbox() {
	var items=document.getElementsByName('CheckBoxInputName');
	var selected = "";
...
// 			items.push($(this).val()); //체크된 값을 배열에 push
// 			var items = $(this).val();
// 			console.log(items);
// 		});
...
<button type="button" id="btnUpdate" class="btn btn-dark" onclick="checkedbox()">수정</button>
